		...
		<div className="container flex justify-between items-center select-none">
			<nav className="flex">
				<Link
					...
					href="/"
				>
					<Image className="hidden md:block" width={110} height={40} src="/logo-big.svg" alt="logo big" />
					<Image className="block md:hidden" width={36} height={36} src="/logo-small.svg" alt="logo small" />
				</Link>
			...
			<div className="flex gap-x-4 lg:gap-x-8 items-center flex-grow justify-end">
				<Search />
				<Link className={twclsx(buttonVariants(), "hidden lg:flex")} href="/auth">
					Sign in
				</Link>
				<MobileMenu />
			</div>
